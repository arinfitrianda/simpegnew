...
$id_pendNonformal = $_POST["id_pendNonformal"];
...
if (empty($scan_files)){
	$update = $db->prepare("UPDATE pegawai_pend_nonformal SET tingkat_pendidikan=:tingkat_pendidikan, fakultas=:fakultas, jurusan=:jurusan, nomor_sttb=:no_sttb, tanggal_sttb=:tanggal_sttb, nama_kepsek=:nama_kepsek, nama_sekolah=:nama_sekolah, lokasi_sekolah=:lokasi_sekolah, nama_perguruan_tinggi=:nama_perguruan_tinggi, update_at=:update_at WHERE id_pend_nonformal=:id_pendNonformal AND id_pegawai=:id_pegawai");

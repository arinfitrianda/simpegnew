...
if (empty($scan_files)){
	$update = $db->prepare("UPDATE riwayat_sip SET no_sip=:no_sip, tgl_terbit_sip=:tgl_terbit_sip,tgl_kadaluarsa_sip=:tgl_kadaluarsa_sip, pejabat_ttd=:pejabat_ttd, keterangan=:keterangan, update_at=:update_at WHERE id_sip=:id_sip AND id_pegawai=:id_pegawai");
	$update->BindParam(":id_sip", $id_sip);
	$update->BindParam(":id_pegawai", $id_pegawai);
	$update->BindParam(":no_sip", $no_sip);
	$update->BindParam(":tgl_terbit_sip", $tgl_terbit_sip);
	$update->BindParam(":tgl_kadaluarsa_sip", $tgl_kadaluarsa_sip);
...
$dir_file = "../upload_simpeg/$id_pegawai/";	
	...
	{	
		...
		{
			$update = $db->prepare("UPDATE riwayat_sip SET no_sip=:no_sip, tgl_terbit_sip=:tgl_terbit_sip,tgl_kadaluarsa_sip=:tgl_kadaluarsa_sip, pejabat_ttd=:pejabat_ttd, keterangan=:keterangan, nama_doc=:nama_doc, url_doc=:url_doc,update_at=:update_at WHERE id_sip=:id_sip AND id_pegawai=:id_pegawai");
			$update->BindParam(":id_sip", $id_sip);
			$update->BindParam(":id_pegawai", $id_pegawai);
			$update->BindParam(":no_sip", $no_sip);
			$update->BindParam(":tgl_terbit_sip", $tgl_terbit_sip);

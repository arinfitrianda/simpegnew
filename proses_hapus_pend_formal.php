...
$id_pendFormal = $_GET["id_pendFormal"];
$update = date('Y-m-d H:i:s');

$update = $db->prepare("UPDATE pegawai_pend_formal SET status='1', update_at=:update_at WHERE id_pend_formal=:id_pendFormal AND id_pegawai=:id_pegawai");

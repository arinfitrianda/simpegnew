    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            DATA PEGAWAI
            <small>Form Tambah Pegawai</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Form Tambah Pegawai</li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <form class="" action="tambah_pegawai.php" method="post">
            <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="nip" class="form-control" id="nip" placeholder="Masukan Nomor Induk Pegawai disini." required>
                    </div>
                    <div class="form-group">
                      <label for="ktp">Nomor KTP <span style="color:red">*</span></label>
                      <input type="text" name="ktp" class="form-control" id="ktp" placeholder="Masukan Nomor KTP disini." required>
                    </div>
                    <div class="form-group">
                      <label for="npwp">NPWP</label>
                      <input type="text" name="npwp" class="form-control" id="npwp" placeholder="Masukan NPWP disini.">
                    </div>
										<div class="form-group">
                      <label for="askes">Nomor Askes <span style="color:red">*</span></label>
                      <input type="text" name="askes" class="form-control" id="askes" placeholder="Masukan Nomor Askes disini." required>
                    </div>
										<div class="form-group">
                          ...
                          <input type="date" name="tmt_pegawai" class="form-control" id="tmt_pegawai" placeholder="Masukan TMT Pegawai disini." required>
												</div>
											</div>
                    </div>
										<div class="form-group">
                      ...
                      <input type="text" name="jenis_jabatan" class="form-control" id="jenis_jabatan" placeholder="Masukan Jenis Jabatan disini." required>
                    </div>
										<div class="form-group">
                      <label for="nama_jabatan">Nama Jabatan <span style="color:red">*</span></label>
                      <input type="text" name="nama_jabatan" class="form-control" id="nama_jabatan" placeholder="Masukan Nama Jabatan disini." required>
                    </div>
										<div class="form-group">
                      <label for="tmt_jabatan">TMT Jabatan <span style="color:red">*</span></label>
                      <input type="date" name="tmt_jabatan" class="form-control" id="tmt_jabatan" placeholder="Masukan TMT Jabatan disini." required>
                    </div>
                    <div class="form-group">
											<div class="col-md-4 col-lg-4">
												<div class="form-group">
													<label for="prefix">Gelar Depan </label>
		                      <input type="text" name="prefix" class="form-control" id="prefix" placeholder="Masukan Gelar Depan disini.">
												</div>
											</div>
											<div class="col-md-4 col-lg-4">
												<div class="form-group">
													<label for="nama_lengkap">Nama Lengkap <span style="color:red">*</span></label>
		                      <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Masukan Nama Lengkap disini." required>
												</div>
											</div>
											<div class="col-md-4 col-lg-4">
												<div class="form-group">
													<label for="postfix">Gelar Belakang</label>
		                      <input type="text" name="postfix" class="form-control" id="postfix" placeholder="Masukan Gelar Belakang disini.">
												</div>
											</div>
                    ...
                    <div class="form-group">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" placeholder="Masukan Tempat lahir disini." required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="tanggal_lahir">Tanggal Lahir <span style="color:red">*</span></label>
                          <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" placeholder="Masukan Tanggal Lahir disini." required>
                        </div>
                      </div>
                    </div>
                    <!-- end block ttl -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="pendidikan_awal" class="form-control" id="pendidikan_awal" placeholder="Masukan Pendidikan Awal disini." required>
                    </div>
										<div class="form-group">
                      <label for="tahun_pendidikan_awal">Tahun Pendidikan Awal <span style="color:red">*</span></label>
                      <input type="text" name="tahun_pendidikan_awal" class="form-control" id="tahun_pendidikan_awal" placeholder="Masukan Tahun Pendidikan Awal disini." required>
                    </div>
										<div class="form-group">
                      <label for="pendidikan_akhir">Pendidikan Akhir <span style="color:red">*</span></label>
                      <input type="text" name="pendidikan_akhir" class="form-control" id="pendidikan_akhir" placeholder="Masukan Pendidikan Akhir disini." required>
                    </div>
										<div class="form-group">
                      <label for="tahun_pendidikan_akhir">Tahun Pendidikan Akhir <span style="color:red">*</span></label>
                      <input type="text" name="tahun_pendidikan_akhir" class="form-control" id="tahun_pendidikan_akhir" placeholder="Masukan Tahun Pendidikan Akhir disini." required>
                    </div>
                  </div>
                  <div class="col-md-6">
										<div class="form-group">
                      <label for="alamat">Alamat <span style="color:red">*</span></label>
                      <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Masukan Alamat disini."required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="kode_pos" class="form-control" id="kode_pos" placeholder="Masukan Kode Pos Disini." required>
                    </div>
                    <div class="form-group">
                      <label for="email">Email <span style="color:red">*</span></label>
                      <input type="email" name="email" class="form-control" id="email" placeholder="Masukan Email disini." required>
                    </div>
                    <div class="form-group">
                      <label for="telepon">Telepon <span style="color:red">*</span></label>
                      <input type="text" name="telepon" class="form-control" id="telepon" placeholder="Masukan Nomor Telepon Disini." required>
                    </div>
										<div class="form-group">
                      <label for="wea">No.WA </label>
                      <input type="text" name="wea" class="form-control" id="wea" placeholder="Masukan Nomor Whatsapp Disini.">
                    </div>
                  </div>
                </div>

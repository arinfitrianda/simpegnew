            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header">
				  ...
				  <button onclick="window.location.href='exportrekap.php?bagian=<?php echo $bagian; ?>&gabung=<?php echo $gabung; ?>'" class="btn btn-success pull-right"><i class="fa fa-download"></i> Export ke Excel</button>
                </div><!-- /.box-header -->
                <div class="box-body">

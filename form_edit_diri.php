    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form class="" action="edit_pegawai_diri.php" method="post">
            ...
            <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="jenis_profesi">Jenis Profesi</span></label>
                      <input type="text" name="jenis_profesi" class="form-control" id="jenis_profesi" placeholder="Masukan Jenis Profesi disini." value="<?php echo $m['jenis_profesi']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="nama_profesi">Nama Profesi </label>
                      <select class="form-control" name="nama_profesi">

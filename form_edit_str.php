...
$id_str = isset($_GET['id_str']) ? $_GET['id_str'] : '';

$getData = $db->prepare("SELECT * FROM riwayat_str WHERE id_str=:id_str AND id_pegawai=:id_pegawai");
$getData->bindParam(":id_pegawai",$id_pegawai);
$getData->bindParam(":id_str",$id_str);
$getData->execute();
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>Form Edit Data Surat Tanda Registrasi</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Form Edit Data Surat Tanda Registrasi</li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box-header">
              <i class="fa fa-user"></i>
    				  <h3 class="box-title">Form Edit Data Surat Tanda Registrasi</h3>
            </div><!-- /.box-header -->
            <form class="" action="proses_edit_str.php" enctype="multipart/form-data" method="post">
              <input type="hidden" name="id_pegawai" value="<?php echo $id_pegawai; ?>">
              <input type="hidden" name="id_str" value="<?php echo $id_str; ?>">
            <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="no_str">Nomor Surat Tanda Registrasi<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="no_str" name="no_str" value="<?php echo $data["no_str"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="tgl_terbit_str">Tanggal Terbit Surat Tanda Registrasi<span style="color:red">*</span></label>
                      <input type="date" class="form-control" id="tgl_terbit_str" name="tgl_terbit_str" value="<?php echo $data["tgl_terbit_str"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="tgl_kadaluarsa_str">Tanggal Terbit Surat Tanda Registrasi<span style="color:red">*</span></label>
                      <input type="date" class="form-control" id="tgl_kadaluarsa_str" name="tgl_kadaluarsa_str" value="<?php echo $data["tgl_kadaluarsa_str"]?>" required>
                    </div>
                    <div class="form-group">

            ...
            if(empty($m)){?>
              <div class="box-body">
                <div class="alert alert-danger">
                  <strong>Info!</strong> Anda belum melengkapi Data Profesi, Silahkan lengkapi Data Profesi
                </div>
              </div>
            <?php
            }else{?>
            <div class="box-body">
              ...
              <form action="proses_asesi_pribadi.php" method="post">
                <table class="table" >
                  ...
                  <?php
                        include("../inc/pdo.conf.php");
                        $queryKompetensi  = $db->prepare("SELECT * FROM asesmen_kompetensi WHERE id_profesi=:id_profesi");
                        ...
                        foreach ($dataKompetensi as $dk){
                          ...
                          <tr>
                            ...
                            <td>
                              <input type="radio" id="m1" name="jawaban<?php echo $nomor ?>" value="1"><span for="spkk"> 1</span>
                            </td>
                            <td>
                              <input type="radio" id="ds2" name="jawaban<?php echo $nomor ?>" value="2"><span for="spkk"> 2</span>
                            </td>
                            <td>
                              <input type="radio" id="ta3" name="jawaban<?php echo $nomor ?>" value="3"><span for="spkk"> 3</span>
                            </td>
                            <td>
                  ...
                  <?php
                        ...
                        foreach ($dataKompetensi as $dk){
                          ...
                          <tr>
                            ...
                            <td><?php echo $dk['sub_soal'] ?></td>
                             <td>
                              <input type="checkbox" id="m1" name="jawaban<?php echo $nomor ?>" value="1" <?php if($dk['jawaban_asesi'] == '1'){ echo"checked"; } ?>><span for="spkk"> 1</span>
                            </td>
                            <td>
                              <input type="checkbox" id="ds2" name="jawaban<?php echo $nomor ?>" value="2"<?php if($dk['jawaban_asesi'] == '2'){ echo"checked"; } ?>><span for="spkk"> 2</span>
                            </td>
                            <td>
                              <input type="checkbox" id="ta3" name="jawaban<?php echo $nomor ?>" value="3"<?php if($dk['jawaban_asesi'] == '3'){ echo"checked"; } ?>><span for="spkk"> 3</span>
                            </td>
                            <td>
                              <button id="blue-button" type="button" class="btn btn-sm btn-success bg-navy" data-toggle="modal" data-target="#modalPokokBahasan" data-color="peter" id="<?php echo $row["id_kompetensi"]; ?>">Lihat Pokok Bahasan Kewenangan Klinis</button>
                            </td>
                ...
                <?php
                   ...
                   <a href="cetak_asesi_pribadi.php?id=<?php echo $id_pegawai?>" class="btn bg-navy" target="_BLANK">Cetak Hasil Asesi Pribadi</a>
                <?php
                }
              }
                ?>
...
<div id="modalPokokBahasan" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      o Peran dan tanggung jawab Apoteker dalam meningkatkan keamanan, efektifitas dan dampak ekonomi penggunaan obat secara individual <br>
      o Pharmaceutical care proses:<br>
      • Penilaian / assessment<br>
      • Pharmaceutical care plan <br>
      • Intervensi terhadap adanya DTPs (Drug Teraphy Problems)<br>
      • Tindak lanjut: kegiatan monitoring dan evaluasi obat<br>
      o Konsep penyakit terpilih: anatomi-fisiologi manusia, etiologi, prognosis, pato-fisiologi, tanda serta gejala<br>
      o Interpretasi data klinis: hasil pemeriksaan fisik, hasil pemeriksaan laboratorium, alat diagnostik dan instrument<br>
      o Farmakoterapi penyakit terpilih, identifikasi reaksi obat yang tidak dikehendaki dari penggunaan obat tunggal ADR (Adverse Drug Reaction), maupun interaksi obat<br>

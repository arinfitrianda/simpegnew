...
$dir_file = "../upload_simpeg/$id_pegawai/";	
	...
	{	
		...
		{		
			$insert = $db->prepare("INSERT INTO riwayat_str(id_pegawai, no_str, tgl_terbit_str, tgl_kadaluarsa_str, pejabat_ttd, keterangan, nama_doc, url_doc, create_at) VALUES (:id_pegawai, :no_str, :tgl_terbit_str, :tgl_kadaluarsa_str, :pejabat_ttd, :keterangan, :nama_doc, :url_doc, :create_at)");
			    $insert->BindParam(":id_pegawai", $id_pegawai);
			    $insert->BindParam(":no_str", $no_str);
			    $insert->BindParam(":tgl_terbit_str", $tgl_terbit_str);
			    $insert->BindParam(":tgl_kadaluarsa_str", $tgl_kadaluarsa_str);

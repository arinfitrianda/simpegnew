...
$id_pendNonformal = isset($_GET['id_pendNonformal']) ? $_GET['id_pendNonformal'] : '';

$getData = $db->prepare("SELECT * FROM pegawai_pend_nonformal WHERE id_pend_nonformal=:id_pendNonformal AND id_pegawai=:id_pegawai");
$getData->bindParam(":id_pegawai",$id_pegawai);
$getData->bindParam(":id_pendNonformal",$id_pendNonformal);
$getData->execute();
$data_pendNonformal = $getData->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form class="" action="proses_edit_pend_nonformal.php" enctype="multipart/form-data" method="post">
              <input type="hidden" name="id_pegawai" value="<?php echo $id_pegawai; ?>">
              <input type="hidden" name="id_pendNonformal" value="<?php echo $id_pendNonformal; ?>">
            <div class="box-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="tingkat_pendidikan" id="tingkat_pendidikan" required>
                          <option value="<?php echo $data_pendNonformal["tingkat_pendidikan"]?>"><?php echo $data_pendNonformal["tingkat_pendidikan"]?></option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="fakultas" name="fakultas" value="<?php echo $data_pendNonformal["fakultas"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="jurusan">Jurusan<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?php echo $data_pendNonformal["jurusan"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="nomor_sttb">Nomor Ijazah/STTB<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="nomor_sttb" name="nomor_sttb" value="<?php echo $data_pendNonformal["nomor_sttb"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="tanggal_sttb">Tanggal Ijazah/STTB<span style="color:red">*</span></label>
                      <input type="date" class="form-control" id="tanggal_sttb" name="tanggal_sttb" value="<?php echo $data_pendNonformal["tanggal_sttb"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="nama_kepsek">Nama Kepala Sekolah/Rektor<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="nama_kepsek" name="nama_kepsek" value="<?php echo $data_pendNonformal["nama_kepsek"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="nama_sekolah">Nama Sekolah<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah" value="<?php echo $data_pendNonformal["nama_sekolah"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="lokasi_sekolah">Lokasi Sekolah<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="lokasi_sekolah" name="lokasi_sekolah" value="<?php echo $data_pendNonformal["lokasi_sekolah"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="nama_pt">Nama Perguruan Tinggi<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="nama_pt" name="nama_pt" value="<?php echo $data_pendNonformal["nama_perguruan_tinggi"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="nama_pt">Dokumen Terupload</label><br>
                      <a target='_blank' href="<?php echo $data_pendNonformal['url_doc']."/".$data_pendNonformal['nama_doc']?>"><?php echo $data_pendNonformal['nama_doc']?></a>
                    </div>
                    <div class="form-group">

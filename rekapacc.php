            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header">
				  ...
				  <h3 class="box-title">Rekap Absen <?php echo $nama; ?></h3>
				  <button onclick="window.location.href='export.php?id=<?php echo $id; ?>&gabung=<?php echo $gabung; ?>'" class="btn btn-success pull-right"><i class="fa fa-download"></i> Export ke Excel</button>
                </div><!-- /.box-header -->
                <div class="box-body">

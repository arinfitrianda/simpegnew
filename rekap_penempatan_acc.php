  ...
  <body class="skin-black">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<!-- pesan feedback -->
	    <?php if (isset($_GET['status']) && ($_GET['status'] == "1")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-check"></i>Berhasil</h4>Data pasien telah didistribusikan</center></div>
	...
	<?php } else if (isset($_GET['status']) && ($_GET['status'] == "3")) { ?><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-ban"></i>Peringatan!</h4>Data pasien gagal diubah</center></div>
        ...
        <section class="content-header">
          <h1>
            Data
            <small>Riwayat Penempatan</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Data Riwayat Penempatan</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header">
				  ...
				  <h3 class="box-title">Data Riwayat Penempatan</h3>
				  <button onclick="window.location.href='exportpenempatan.php?tahun=<?php echo $tahun; ?>'" class="btn btn-success pull-right"><i class="fa fa-download"></i> Export ke Excel</button>
                </div><!-- /.box-header -->
                <div class="box-body">

      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			  ...
			  <div class="box">
				...
				<!-- form start -->
                <form role="form" action="datarekapacc.php" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="bagian">Pilih Bagian</label>
                      <select class="form-control" name="bagian">
                        <option value="1">Direksi dan Sub Bag Tata Usaha</option>
						<option value="2">Sarana dan Prasarana</option>
						<option value="3">Pelayanan dan Penunjang Medik</option>
						<option value="4">Keperawatan</option>
						<option value="5">Cleaning Service</option>

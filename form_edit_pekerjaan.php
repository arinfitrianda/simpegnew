...
$getData = $db->prepare("SELECT * FROM riwayat_pekerjaan WHERE id_pekerjaan=:id_pekerjaan AND id_pegawai=:id_pegawai");
$getData->bindParam(":id_pegawai",$id_pegawai);
$getData->bindParam(":id_pekerjaan",$id_pekerjaan);
$getData->execute();
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            DATA RIWAYAT Cuti
            <small>Form Edit Data Riwayat Cuti</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Form Edit Data Riwayat Cuti</li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box-header">
              <i class="fa fa-user"></i>
    				  <h3 class="box-title">Form Edit Data Riwayat Cuti</h3>
            </div><!-- /.box-header -->
            <form class="" action="proses_edit_pekerjaan.php" method="post">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nama_perusahaan" name="nama_perusahaan" value="<?php echo $data["nama_perusahaan"]?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="tgl_mulai_kerja">Tanggal Mulai Bekerja<span style="color:red">*</span></label>
                      <input type="date" class="form-control" id="tgl_mulai_kerja" name="tgl_mulai_kerja" value="<?php echo $data["tgl_mulai_kerja"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="tgl_selesai_kerja">Tanggal Selesai Bekerja<span style="color:red">*</span></label>
                      <input type="date" class="form-control" id="tgl_selesai_kerja" name="tgl_selesai_kerja" value="<?php echo $data["tgl_selesai_kerja"]?>" required>
                    </div>
                    <div class="form-group">
                      <label for="alasan_keluar_kerja">Alasan Berhenti Bekerja<span style="color:red">*</span></label>
                      <input type="text" class="form-control" id="alasan_keluar_kerja" name="alasan_keluar_kerja" value="<?php echo $data["alasan_keluar_kerja"]?>" required>
                    </div>
                    <div class="form-group">

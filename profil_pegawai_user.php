							...
							<div class="row">
								...
								<div class="col-md-8">
										...
										<div class="form-group">
											<a href="form_edit_diri.php?d=<?php echo $id; ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit Data Master</a>
										</div>
								</div>
							</div>
							<div class="row">
	                                ...
	                                foreach ($RiwayatOrtu as $data_ortu) {
	                                  ...
	                                  echo "<tr>
	                                          ...
	                                          <td>
	                                            ...
	                                            <a  target='_blank' href='proses_hapus_ortu.php?id_pegawai=$id&id_ortu=$id_ortu' class='btn btn-block btn-xs btn-danger'><i class='fa fa-trash' onclick='return deleteconfig()'></i> Hapus Data</a>
	                                          </td>
	                                        </tr>";
	                                }
	                              ?>
			...
			<div class="modal">
	          ...
	          <form action="proses_pendidikan_nonformal.php" class="form-horizontal" enctype="multipart/form-data" id="formInput" method="POST">
	            <input type="hidden" id="id_pegawai" name="id_pegawai" value="<?php echo $id; ?>">
	              ...
	              <div class="form-group">
	                <label class="control-label col-sm-3" for="nama_perguruan_tinggi">Nama Sekolah / Perguruan Tinggi<span style="color:red">*</span></label>
	                <div class="col-sm-9">
